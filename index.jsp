...
<!-- #container -->
<em class="fullbg"></em>
<em class="pointimg"><img src="" alt=""></em>
					...
					<ul class="Introduction">
						...
						<li class="last">
							...
							<div class="con">
								...
								<p>
									포스터, 카드뉴스, 현수막, 명함 등 디자인 경험이 있으며, 웹퍼블리셔 과정을 진행하며 홈페이지 디자인 또한 배웠습니다.
								</p>

								<h4>Content Marketing</h4>
								<p>
									<em class="xi-photoshop">
										<b class="ally-hidden">인스타그램</b>
									</em>
									<em class="xi-illustrator">
										<b class="ally-hidden">페이스북</b>
									</em>
									<em class="xi-illustrator">
										<b class="ally-hidden">블로그</b>
									</em>
									<em class="xi-illustrator">
										<b class="ally-hidden">유투브</b>
									</em>
								</p>
								<p>SNS체널 운영, 언론보도 작성 및 배포가 가능합니다.<br />
								카드뉴스, 블로그, 영상 콘텐츠, 이벤트 기획 및 제작, 행사(서포터즈, 지점 오픈 등) 모집 및 운영의 경험이 있습니다.</p>
							</div>
						</li>
	...
	<div class="section-group-2 section-group ">
		...
		<section class="main_prosect_list section">
			<div class="prosect_wrap">
				...
				<p class="sec_subtxt">Pick ! <br>Web Project.</p>
		...
		<section class="main_profile_02 section " >
			...
			<div class="profile_con">
				<ul>
					<li>
						<p class="date">2017</p>
						<h3>그린아트컴퓨터학원 0000과정 이수</h3>
					</li>	
					<li>
						<p class="date">2016~2017</p>
						<h3>(주)무궁</h3>
						<p>마케팅팀 (사원)</p>
						<p>웨딩홀사업부 6개, 드레스사업부 2개 지점<br />온라인 및 오프라인 홍보<br />행사 관리 및 지원</p>
					</li>
					<li>
